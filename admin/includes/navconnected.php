...
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul class="left hide-on-med-and-down">
        <li><img src="users/logo.png" alt="VK E-Store Logo" class="responsive-img" style="height: 50px; max-width: 180px; "></li>
         <li><a href="index.php" class="dark-text">VK E-Store Admin Panel</a></li>
   </ul>
