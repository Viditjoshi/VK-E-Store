<footer class="page-footer">
    <div class="container footer-info">
        <div class="row">
            <div class="col s12 l4 ">
                ...
                <ul>
                    <li><a class="grey-text text-lighten-3 animated slideInUp wow" href="https://github.com/jacobjohn2016"><i class="tiny material-icons" style="position:relative;top:3px">developer_mode</i>Vidit Joshi</a></li>
                    <li><a class="grey-text text-lighten-3 animated slideInUp wow" href="https://smakosh.com/"><i class="tiny material-icons" style="position:relative;top:3px">developer_mode</i>Krupesh Chavada</a></li>
                    <li></li>
                </ul>
            </div>
            <div class="col s12 l4 ">
                <h5 class="grey-text text-lighten-3 animated slideInUp wow">Categories</h5>
                <ul>
            ...
            <div class="col s12 l4 ">
                <h5 class="grey-text text-lighten-3 animated slideInUp wow"></h5></br>
                <ul>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            Vidit Joshi and Krupesh Chavada</a>
        </div>
    </div>
</footer>
